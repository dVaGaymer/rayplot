...
# define DEFAULT_X_RANGE {-1, 1}
# define DEFAULT_Y_RANGE {-1, 1}
...
# define DEFAULT_GRID_NUM_TEXT_SIZE 0.05 * (ax->bounds.height < ax->bounds.width ? ax->bounds.height : ax->bounds.width)
